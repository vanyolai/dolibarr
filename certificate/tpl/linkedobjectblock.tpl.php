...
global $linkedObjectBlock, $noMoreLinkedObjectBlockAfter;
...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	<tr class="<?php echo $trclass; ?>">
		...
		<td></td>
		<td class="center"><?php echo dol_print_date($objectlink->date_completion ? $objectlink->db->jdate($objectlink->date_completion) : 0, 'day'); ?></td>
		<td class="right"></td>
