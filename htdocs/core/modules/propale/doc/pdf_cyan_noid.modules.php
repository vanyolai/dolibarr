...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_cyan_noid.modules.php
 *	\ingroup    propale
 *	\brief      File of Class to generate PDF proposal with Cyan NoID template
 */
...
/**
 *	Class to generate PDF proposal Cyan NoID
 */
class pdf_cyan_noid extends ModelePDFPropales
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		// This template intentionally never exposes the internal product/service reference.
		$hideref = 1;
